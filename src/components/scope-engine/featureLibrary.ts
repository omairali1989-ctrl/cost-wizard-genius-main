...
export const COMPLEXITY_LABELS: Record<Complexity, { label: string; description: string; color: string }> = {
  low:    { label: "Simple",  description: "Standard patterns, minimal customisation", color: "emerald" },
  medium: { label: "Medium",  description: "Custom logic, moderate complexity",         color: "amber"   },
  high:   { label: "Complex", description: "Advanced features, integrations, edge-cases", color: "red"  },
};
...
// ─── Category meta ────────────────────────────────────────────────────────────
export const CATEGORY_META: Record<FeatureCategory, { label: string; icon: string; color: string }> = {
  discovery: { label: "Discovery & Planning",     icon: "🔍", color: "text-violet-500" },
  design:    { label: "UI/UX Design",             icon: "🎨", color: "text-pink-500"   },
  frontend:  { label: "Frontend / Web",           icon: "🖥️", color: "text-blue-500"  },
  backend:   { label: "Backend / API",            icon: "⚙️", color: "text-amber-500" },
  mobile:    { label: "Mobile App",               icon: "📱", color: "text-green-500" },
  ecommerce: { label: "E-Commerce",               icon: "🛒", color: "text-orange-500"},
  integration:{ label: "Integrations & Real-Time",icon: "🔗", color: "text-cyan-500"  },
  devops:    { label: "DevOps & Infrastructure",  icon: "🚀", color: "text-indigo-500"},
  testing:   { label: "QA & Testing",             icon: "🧪", color: "text-red-500"   },
  cms:       { label: "CMS / WordPress",          icon: "🎭", color: "text-lime-500"  },
  social:    { label: "Social Media Design",      icon: "📸", color: "text-rose-500"  },
};
...
export const ROLE_LABELS: Record<RoleKey, { label: string; short: string; color: string }> = {
  designer: { label: "Design",          short: "Design",   color: "bg-pink-500"   },
  frontend: { label: "Frontend Dev",    short: "Frontend", color: "bg-blue-500"   },
  backend:  { label: "Backend Dev",     short: "Backend",  color: "bg-amber-500"  },
  mobile:   { label: "Mobile Dev",      short: "Mobile",   color: "bg-green-500"  },
  pm:       { label: "Project Mgmt",    short: "PM",       color: "bg-violet-500" },
  qa:       { label: "QA / Testing",    short: "QA",       color: "bg-red-500"    },
};
