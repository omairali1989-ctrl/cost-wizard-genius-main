  ...
  head: () => ({
    meta: [
      ...
      { title: "CostCraft — Software Project Cost & Pricing Calculator" },
      {
        name: "description",
        content:
          "Work out the true cost of software projects and price them with confidence: team hours, overheads, contingency and margin in one place.",
      },
      { property: "og:title", content: "CostCraft — Software Cost & Pricing Calculator" },
      {
        property: "og:description",
        content: "Cost software projects accurately and price them with confidence.",
      },
